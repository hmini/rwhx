<template>
    <div class="page page-xjgl">
        <el-container>
            ...
            <div class="left colorhs">编辑学生</div>
        </el-header>
        <el-main>
...
import {dicGrade,dicDepartment,dicSpecialty,dicTeam,dicRole,editStu,stuOne} from '@/api';
        ...
        methods:{
            ...
            async studentInfo(){
                ...
                if(res.code==200){
                    ...
                    this.form.origin= this.fhz(res.data.origin);
                    this.form.mobile= this.fhz(res.data.mobile);
                    this.form.grade_id= this.fhz(res.data.grade_id);
                    this.form.department_id= this.fhz(res.data.department_id);
                    this.form.specialty_id= this.fhz(res.data.specialty_id);
                    this.form.team_id= this.fhz(res.data.team_id);
